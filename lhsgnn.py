...
def lhsgnn(A,test_pos, test_pos_subgraphs ,test_neg, test_neg_subgraphs, train_pos,
    ...
    if args.use_embedding:
        ...
        for index,neg in enumerate(test_neg):
            for i,j in test_neg_subgraphs[index]: # inject negative 
                A1[neg[i],neg[j]] = 0
                A1[neg[j],neg[i]] = 0 
        
        
        embeddings = generate_node2vecmotif_embeddings_motif( A1, 128, True, train_pos, train_pos_subgraphs, train_neg, train_neg_subgraphs, test_pos, test_pos_subgraphs ,test_neg, test_neg_subgraphs,args)
    ...
    # train_with_early_stopping(model, device, optimizer, train_loader, val_loader, patience=10,args)
